...
var NoteSearch = _interopRequire(require("./note-search.jsx"));

var NoteList = _interopRequire(require("./note-list.jsx"));

var NoteEditable = _interopRequire(require("./note-editable.jsx"));
...
var NoteApp = React.createClass({
  ...
  handleNoteSave: function handleNoteSave(old_note, new_note) {
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(NoteEditable, { note: firstNote, onChange: this.handleNoteSave })
    );
  }
});
...
},{"./note-editable.jsx":158,"./note-list.jsx":160,"./note-search.jsx":161,"react":156}],158:[function(require,module,exports){
"use strict";
...
var NoteEditable = React.createClass({
  ...
  updateNoteContent: function updateNoteContent(e) {
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "form",
        { className: "noteEditForm", onSubmit: this.handleSubmit },
        React.createElement("input", { value: this.state.note.title, style: input_styles, onChange: this.handleTitleChange, ref: "title" }),
        React.createElement("br", null),
        React.createElement("textarea", { value: this.state.note.body, style: textarea_styles, onChange: this.handleBodyChange, ref: "body" })
      )
    );
  }
});

module.exports = NoteEditable;
...
var NoteItem = React.createClass({
  ...
  handleNoteSelection: function handleNoteSelection(e) {
    e.preventDefault();
    var evt = new CustomEvent("noteSelected", {
      detail: {
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          { href: "#", onClick: this.handleNoteSelection },
...
var NoteItem = _interopRequire(require("./note-item.jsx"));
...
},{"./note-item.jsx":159,"react":156}],161:[function(require,module,exports){
"use strict";
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("input", { type: "text", placeholder: "Add a new note...", ref: "query" }),
...
var NoteApp = _interopRequire(require("./components/note-app.jsx"));

var data = [{ title: "Hello World", body: "This is one note" }, { title: "Ideas", body: "This is another note. A slightly bigger note." }];

React.render(React.createElement(NoteApp, { data: data }), document.getElementById("content"));

},{"./components/note-app.jsx":157,"react":156}]},{},[162]);
